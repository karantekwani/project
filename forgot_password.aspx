					...
					<div class="col-md-8">
						<div class="billing-details">
							...
							<div class="form-group">
                                <label>EMAIL</label>      							
                                <asp:TextBox ID="txtEmail" required pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}"  title="please enter your registered Email ID" runat="server" CssClass="form-control" placeholder="Enter Email" />
                            </div>
